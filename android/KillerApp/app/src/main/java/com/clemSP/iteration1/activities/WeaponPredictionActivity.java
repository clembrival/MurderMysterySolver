 ...
 */
public class WeaponPredictionActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weapon_prediction);
    ...
    private void retrievePrediction()
    {
        ...
        mWeaponRes = bundle.getInt("dataset");
        ...
        switch (mWeaponRes)
        {
            ...
            case R.string.strangling: mWeaponIndex = 7; break;
            case R.string.none: mWeaponIndex = 7; break;
            default:
                mWeaponRes = R.string.error;
    ...
    private void inflateWidgets()
    {
        ...
        backButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                WeaponPredictionActivity.this.finish();
            }
        });
    ...
    {
        int percentage = VariableDataset.get(this, true).getConfidence();
    ...
    {
        Dialog answerDialog = new Dialog(WeaponPredictionActivity.this);
    ...
    private void inflateDialogSpinner(Dialog dialog)
    {
        ...
        mWeaponSpinner = (Spinner) dialog.findViewById(R.id.spinner);
    ...
    private void inflateDialogButtons(final Dialog dialog)
    {
        ...
        okButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                View weapon = mWeaponSpinner.getSelectedView();
                if(R.string.select_label == (int)weapon.getId())
                {
                    Toast.makeText(WeaponPredictionActivity.this, R.string.right_answer_error,
                            Toast.LENGTH_SHORT).show();
                    return;
                }
                VariableDataset.get(WeaponPredictionActivity.this, true).retrainClassifier();
                dialog.dismiss();
                setResult(RESULT_OK);
                WeaponPredictionActivity.this.finish();
            }
