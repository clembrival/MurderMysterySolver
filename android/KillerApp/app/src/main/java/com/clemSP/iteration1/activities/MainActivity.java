...
public class MainActivity extends BaseActivity implements BaseInputFragment.OnFeaturesInputListener
{
    ...
    private void layoutActivityFragment()
    {
        ...
        Fragment inputFragment = manager.findFragmentById(R.id.fragment_container);
        ...
        if(inputFragment == null)
        {
            ...
            if(inputType == R.id.test_images_button)
            {
                ...
                manager.beginTransaction().add(R.id.fragment_container, imagesInputFragment).commit();
            }
            else
            {
                ...
                manager.beginTransaction().add(R.id.fragment_container, textInputFragment).commit();
            }
        }
    }
