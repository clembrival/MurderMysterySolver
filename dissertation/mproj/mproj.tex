...
\Cref{fig:text_input} and \ref{fig:image_input} shows two different interfaces, one using text input, the other using image input,  displaying the same information.
...
\begin{enumerate}[topsep=0pt]
	...
	\item book's rating,
\end{enumerate}
Combinations of attributes were then expressed as strings of numbers: for example ``125'' means that the selected attributes are the year of publication, the detective and the gender of the victim. (The title of the novel is not included as it is ignored by the classifier, as explained in \Cref{attributes}.)
